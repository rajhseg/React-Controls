...
import { PopupChartItem } from '../Models/models';
...
const RLineChart = forwardRef(function RLineChart({
    ...
    const GetYStartPoint = (displayValue, distance, itemcount, vDistance, spaceFromTopYAxis) => {
    ...
    const DrawText = (text, x, y, forecolor) => {
        if (context) {
            context.beginPath();
...
RLineChart.propTypes = {
    ...
    ChartItems: PropTypes.arrayOf(PropTypes.instanceOf(RLineChartItem))
};
